...
function getHeader()
{
    $output = '<header class="py-3 mb-4  bg-white">
        <div class="d-flex flex-wrap justify-content-center container">
            ...
            <ul class="nav nav-pills" id="gaps">
                <li class="nav-item"><a href="todos.php" class="nav-link active" aria-current="page">Home</a></li>
                <li class="nav-item"><a href="add-todo.php" class="nav-link bg-success text-dark">Add Todo</a></li>
